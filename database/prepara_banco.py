...
usuarios = [
    ('Diogo Pelinson', 'Dxygo', generate_password_hash('lydon').decode('utf-8')),
    ('Mariana Soliguetti', 'Marisoli', generate_password_hash('riva').decode('utf-8')),
    ('Adriana Duarte', 'Dridu', generate_password_hash('python').decode('utf-8'))
]
